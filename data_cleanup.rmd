...
ggplot(immigration_country_current, aes(x = year, y = count, fill = admission_class)) + geom_area(position = 'stack') + labs(y = "Total Immigrants", x = "Year", fill = "Admission Class") 
